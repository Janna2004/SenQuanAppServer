...
INSERT INTO `Categories` VALUES(4,"拍摄点");
...
delete from `Categories` where `catId` = 4;
...
INSERT INTO `Places` VALUES(19,"景点","踩水滩",
							106.48035725911458,106.48035725911458,"8:30-18:00",
...
');
INSERT INTO `Places` VALUES(22,"景点","粉黛草花田",
...
');
INSERT INTO `Places` VALUES(23,"景点","粉黛佳人",
...
INSERT INTO `Places` VALUES(24,"景点","飞花驿站",
...
');
INSERT INTO `Places` VALUES(25,"景点","音乐餐厅",
...
');
INSERT INTO `Places` VALUES(26,"景点","花海婚庆营地",
...
');
INSERT INTO `Places` VALUES(27,"景点","儿童游乐园",
...
');
INSERT INTO `Places` VALUES(28,"景点","自然漂流",
...
');
INSERT INTO `Places` VALUES(23,"景点","游泳池",
							106.45183837890625,26.035994737413194,"8:30-18:00",
							"https://blue.squidward.top/shenquangu_data/photo/0.png","https://blue.squidward.top/shenquangu_data/audio/游泳池.mp3",
							'    游泳不仅是一种美妙的运动，更是一种健康的运动方式。景区游泳池有水循环过滤系统，同时配合消毒液杀菌，再加上有阳光紫外线的作用，景区游泳池的水要比室内的干净。游客可以带上孩子，一起在炎炎夏日，体验游泳的乐趣。
                            ');
